<%-- 
    Document   : clients
    Created on : 7 abr. 2021, 11:33:03
...
<html>
    <head>
        ...
        <!-- Font Awesome -->
        <script src="https://kit.fontawesome.com/afc7c22556.js" crossorigin="anonymous"></script>
    ...
    <body>
        ...
        <!-- Navigation Buttons -->
        <jsp:include page="/WEB-INF/pages/shared/navButtons.jsp"/>
